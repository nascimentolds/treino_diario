...
const TODOS_OS_PLANOS = {
  ...
  dias: {
    segunda: {
      ...
      components: [
        {
          type: "circuito",
          name: "Empurrar – Parte Superior",
          sets: 4,
          rest: 60,
          exercises: [
            { name: "Flexão de braço", type: "reps", value: "Até a falha" },
            { name: "Flexão inclinada (apoio em garrafa)", type: "reps", value: "12-15 reps" },
            { name: "Flexão diamante", type: "reps", value: "10-12 reps" },
            { name: "Elevação frontal com elástico", type: "reps", value: "12-15 reps" }
          ]
        },
        {
          type: "core-block",
          ...
          exercises: [
            ...
            { name: "Canivete abdominal", type: "reps", value: "15 reps" }
          ]
        }
      ]
    },
    terca: {
      title: "Costas, Bíceps e Posterior",
      components: [
        {
          type: "circuito",
          name: "Puxar – Parte Superior",
          sets: 4,
          rest: 60,
          exercises: [
            { name: "Remada com elástico", type: "reps", value: "12-15 reps" },
            { name: "Rosca bíceps com elástico", type: "reps", value: "12-15 reps" },
            { name: "Superman", type: "reps", value: "15 reps" },
            { name: "Ponte de glúteo (ênfase posterior)", type: "reps", value: "20 reps" }
          ]
        },
        {
          type: "core-block",
    ...
    quarta: {
      title: "Descanso Ativo + Core Isométrico",
      components: [
        {
          type: "core-block",
          name: "Estabilidade Central",
          sets: 3,
          rest: 45,
          exercises: [
            { name: "Abdominal infra", type: "reps", value: "20 reps" },
            { name: "Prancha com braço estendido", type: "time", value: 60 },
            { name: "Sprint parado", type: "time", value: 30 }
          ]
        },
        {
          type: "finalizador",
          name: "Mobilidade Leve (opcional)",
          sets: 1,
          rest: 0,
          exercises: [
            { name: "Alongamento dinâmico", type: "time", value: 60 },
            { name: "Respiração profunda em prancha", type: "time", value: 60 }
          ]
        }
      ]
    },
    quinta: {
      title: "Inferiores – Glúteo, Quadríceps, Posterior e Panturrilha",
      components: [
        {
          type: "circuito",
          ...
          rest: 60,
          exercises: [
            { name: "Agachamento livre", type: "reps", value: "20 reps" },
            { name: "Afundo alternado", type: "reps", value: "12-15 reps/perna" },
            { name: "Ponte de glúteo unilateral", type: "reps", value: "12 reps por perna" },
            { name: "Elevação de panturrilha", type: "reps", value: "25 reps" }
          ]
        },
        {
          type: "core-block",
          ...
          rest: 30,
          exercises: [
            { name: "Abdominal com pés elevados", type: "reps", value: "20 reps" },
            { name: "Prancha com toque no ombro", type: "reps", value: "20 reps" }
          ]
        }
      ]
    },
    sexta: {
      title: "Empurrar + Finalizador Metabólico",
      components: [
        {
          type: "circuito",
          name: "Reforço de Peito e Ombro",
          sets: 3,
          rest: 60,
          exercises: [
            { name: "Flexão tradicional", type: "reps", value: "Até a falha" },
            { name: "Flexão diamante", type: "reps", value: "12 reps" },
        ...
        },
        {
          ...
          rest: 30,
          exercises: [
            { name: "Burpee", type: "time", value: 30 },
            { name: "Sprint parado", type: "time", value: 30 },
            { name: "Prancha", type: "time", value: 30 }
          ]
        }
      ]
    }
  ...
  descricao: "Plano estratégico de alta intensidade com foco em queima calórica, HIIT funcional e fortalecimento do core. Ideal para quem busca redução de gordura corporal e melhora do condicionamento físico.",
  dias: {
    segunda: {
      ...
      components: [
        {
          ...
          rest: 60,
          exercises: [
            { name: "Corrida estacionária", type: "time", value: 30, rest: 15 },
            { name: "Burpee", type: "time", value: 30, rest: 15 },
            { name: "Agachamento com salto", type: "time", value: 30, rest: 15 },
            { name: "Mountain climbers", type: "time", value: 30, rest: 0 }
          ]
        },
        {
          type: "core-block",
          ...
          rest: 30,
          exercises: [
            { name: "Abdominal cruzado", type: "reps", value: "30 reps" },
            { name: "Prancha", type: "time", value: 60 },
    ...
    terca: {
      title: "Full Body – Condicionamento Funcional",
      components: [
        {
          type: "circuito",
          name: "Full Body Burn",
          ...
          rest: 60,
          exercises: [
            { name: "Agachamento sumô", type: "reps", value: "20 reps" },
            { name: "Flexão com toque no ombro", type: "reps", value: "15 reps" },
            { name: "Ponte de glúteo", type: "reps", value: "20 reps" },
            { name: "Prancha com toque no ombro", type: "reps", value: "20 reps" }
          ]
        },
        {
      ...
      components: [
        {
          ...
          rest: 60,
          exercises: [
            { name: "Burpee (Tabata)", type: "tabata", value: "4 min" },
            { name: "Corrida estacionária (Tabata)", type: "tabata", value: "4 min" },
            { name: "Agachamento com salto (Tabata)", type: "tabata", value: "4 min" }
          ]
        },
        {
          type: "core-block",
          ...
          exercises: [
            { name: "Prancha lateral", type: "time", value: 30, note: "por lado" },
            { name: "Abdominal bicicleta", type: "reps", value: "30 reps" },
            { name: "Prancha com braço estendido", type: "time", value: 45 }
          ]
        }
      ]
    },
    quinta: {
      title: "Funcional com Ênfase em Resistência",
      components: [
        {
          type: "circuito",
          ...
          exercises: [
            ...
            { name: "Afundo alternado", type: "reps", value: "15 reps/perna" },
            { name: "Flexão tradicional", type: "reps", value: "15 reps" },
            { name: "Agachamento com impulso", type: "reps", value: "20 reps" }
          ]
        },
        {
          type: "core-block",
    ...
    sexta: {
      title: "Queima Final + Core Isométrico",
      components: [
        {
          type: "core-block",
          name: "Core de Controle",
          sets: 3,
          rest: 45,
          exercises: [
            { name: "Abdominal infra", type: "reps", value: "20 reps" },
            { name: "Prancha com respiração profunda", type: "time", value: 60 },
            { name: "Prancha lateral com elevação", type: "time", value: 30, note: "por lado" }
          ]
        },
        {
          type: "finalizador",
          name: "HIIT Finalizador",
          sets: 2,
          rest: 30,
          exercises: [
            { name: "Agachamento com salto", type: "time", value: 30 },
            { name: "Burpee", type: "time", value: 30 },
            { name: "Sprint no lugar", type: "time", value: 20 }
          ]
        }
      ]
    }
  ...
  dias: {
    segunda: {
      title: "Full Body – Força e Estabilidade",
      components: [
        {
          type: 'circuito',
          name: 'Circuito A – Força Global',
          sets: 3,
          rest: 60,
          exercises: [
            { name: 'Agachamento livre', type: 'reps', value: '15 reps' },
            { name: 'Flexão tradicional', type: 'reps', value: '12–15 reps' },
            { name: 'Remada com elástico', type: 'reps', value: '12–15 reps' },
            { name: 'Prancha', type: 'time', value: 45 }
          ]
        },
        {
          type: 'core-block',
          ...
          rest: 45,
          exercises: [
            { name: 'Abdominal infra', type: 'reps', value: '15 reps' },
            { name: 'Prancha lateral', type: 'time', value: 30, note: 'por lado' }
          ]
        }
      ]
    ...
    terca: {
      title: "Cardio Funcional + Core",
      components: [
        {
          type: 'circuito',
          name: 'Bloco Cardio/Core',
          sets: 4,
          rest: 45,
          exercises: [
            { name: 'Corrida estacionária', type: 'time', value: 30 },
            { name: 'Polichinelo', type: 'time', value: 30 },
            { name: 'Abdominal bicicleta', type: 'reps', value: '30 reps' },
            { name: 'Elevação de pernas', type: 'reps', value: '20 reps' }
          ]
    ...
    quarta: {
      title: "Parte Superior – Resistência Muscular",
      components: [
        {
          type: 'circuito',
          ...
          rest: 60,
          exercises: [
            { name: 'Flexão de braço', type: 'reps', value: '12–15 reps' },
            { name: 'Rosca com elástico', type: 'reps', value: '12–15 reps' },
            { name: 'Elevação lateral com elástico', type: 'reps', value: '12 reps' },
            { name: 'Superman', type: 'reps', value: '15 reps' }
          ]
        },
        {
          ...
          rest: 45,
          exercises: [
            { name: 'Abdominal canivete', type: 'reps', value: '15 reps' },
            { name: 'Prancha com braço estendido', type: 'time', value: 45 }
          ]
        }
      ]
      ...
      components: [
        {
          ...
          exercises: [
            ...
            { name: 'Ponte de glúteo', type: 'reps', value: '20 reps' },
            { name: 'Elevação de panturrilha', type: 'reps', value: '25 reps' },
            { name: 'Agachamento isométrico', type: 'time', value: 45 }
          ]
        },
        {
          type: 'core-block',
          ...
          exercises: [
            { name: 'Abdominal com pés elevados', type: 'reps', value: '20 reps' },
            { name: 'Prancha lateral c/ elevação', type: 'time', value: 30, note: 'por lado' }
          ]
        }
      ]
    },
    sexta: {
      title: "Mobilidade + Ativação Leve",
      components: [
        {
          type: 'circuito',
          name: 'Mobilidade e Controle Corporal',
          sets: 2,
          rest: 60,
          exercises: [
            { name: 'Alongamento dinâmico', type: 'time', value: 60 },
            { name: 'Agachamento com peso corporal + mobilidade', type: 'reps', value: '15 reps' },
            { name: 'Prancha com respiração profunda', type: 'time', value: 60 }
          ]
        },
        {
          type: 'finalizador',
          name: 'Fechamento Leve',
          sets: 1,
          rest: 0,
          exercises: [
            { name: 'Caminhada leve no lugar', type: 'time', value: 2 * 60 },
            { name: 'Alongamento estático', type: 'time', value: 90 }
          ]
        }
      ]
    }
  ...
  // Para adicionar mais planos, basta adicionar uma nova chave e objeto aqui,
  // seguindo o mesmo modelo. Ex: "meu_novo_plano": { ... }
};